...
/***/ "./src/main/factories/auth-service-factory.ts":
/*!****************************************************!*\
  !*** ./src/main/factories/auth-service-factory.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.makeAuthService = void 0;\nvar services_1 = __webpack_require__(/*! @/data/services */ \"./src/data/services/index.ts\");\nvar cryptography_1 = __webpack_require__(/*! @/infra/cryptography */ \"./src/infra/cryptography/index.ts\");\nvar bcrypt_factory_1 = __webpack_require__(/*! ./bcrypt-factory */ \"./src/main/factories/bcrypt-factory.ts\");\nvar config_1 = __webpack_require__(/*! @/main/config */ \"./src/main/config/index.ts\");\nvar repos_1 = __webpack_require__(/*! @/infra/repos */ \"./src/infra/repos/index.ts\");\nvar makeAuthService = function () {\n    var bcrypt = (0, bcrypt_factory_1.makeBcrypt)();\n    var jwtAdapter = new cryptography_1.JwtAdapter(config_1.config.jwt, '1d');\n    var authRepo = new repos_1.UserPrismaRepository();\n    var service = new services_1.Authentication(bcrypt, jwtAdapter, authRepo);\n    return service;\n};\nexports.makeAuthService = makeAuthService;\n\n\n//# sourceURL=webpack://api-physiocare/./src/main/factories/auth-service-factory.ts?");

/***/ }),

/***/ "./src/main/factories/bcrypt-factory.ts":
/*!**********************************************!*\
  !*** ./src/main/factories/bcrypt-factory.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.makeBcrypt = void 0;\nvar cryptography_1 = __webpack_require__(/*! @/infra/cryptography */ \"./src/infra/cryptography/index.ts\");\nvar makeBcrypt = function () {\n    var bcrypt = new cryptography_1.BcryptAdapter(10);\n    return bcrypt;\n};\nexports.makeBcrypt = makeBcrypt;\n\n\n//# sourceURL=webpack://api-physiocare/./src/main/factories/bcrypt-factory.ts?");
