...
var helpers_1 = require("@presentation/helpers");
var http_adapter_1 = require("./http-adapter");
var serverlessAdapter = function (controller, event, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, controller.handle({ parsedBody: parsedBody, headers: headers, pathParameters: pathParameters, queryStringParameters: queryStringParameters, requestContext: requestContext })];
            case 1:
                response = _a.sent();
